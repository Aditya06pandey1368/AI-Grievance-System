...
# 1. THE DATASET (With "Context Traps" Fixed)
data = [
    # =========================================================
    # 1. ROAD
    # =========================================================
    ...
    ("Sparks coming from the transformer in the park", "Electricity"), # Trap: Park + Spark
    ("Electric pole inside the park is giving shock", "Electricity"), # Trap: Park + Shock
    ...
    ("Water pipe burst flooding the road", "Water"), # Trap: Road + Flood
    ...
    # =========================================================
    # 5. POLICE (The FIX: Teaching it about "Noise Pollution")
    # =========================================================
    ...
    # --- SPECIFIC TRAINING FOR YOUR ISSUE ---
    ...
    ("Loudspeakers causing headache and noise", "Police"),
    ...
    # =========================================================
    # 8. ENVIRONMENTAL (Context: Factory/Industrial)
    # =========================================================
    ...
    ("Noise pollution from industrial generator", "Environmental Protection"), # Industrial = Env
    ("Factory causing unbearable noise pollution", "Environmental Protection"), # Factory = Env
...
# ngram_range=(1,2) is CRITICAL. It lets AI see "Gas Leak" as one concept.
model = make_pipeline(
...
# 3. TRAIN THE MODEL
print(f"🧠 Training on {len(data)} detailed examples...")
