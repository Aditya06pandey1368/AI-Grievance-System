    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0f172a] transition-colors font-sans text-slate-900 dark:text-slate-100 relative">
      ...
      <div className="pt-24 px-6 max-w-[1600px] mx-auto pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <StatCard label="Pending Action" count={stats.pending} icon={<AlertCircle className="text-orange-600 dark:text-orange-400" />} gradient="from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20" borderColor="border-orange-200 dark:border-orange-800" />
            <StatCard label="Resolved Cases" count={stats.resolved} icon={<CheckCircle className="text-emerald-600 dark:text-emerald-400" />} gradient="from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20" borderColor="border-emerald-200 dark:border-emerald-800" />
            <StatCard label="Total Database" count={stats.total} icon={<Clock className="text-blue-600 dark:text-blue-400" />} gradient="from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20" borderColor="border-blue-200 dark:border-blue-800" />
        </div>
...
const CustomDropdown = ({ value, options, onChange, type }) => {
    ...
    const getBadgeStyle = (option) => {
        ...
        return 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border-slate-300 dark:border-slate-600 hover:border-indigo-500';
    };
