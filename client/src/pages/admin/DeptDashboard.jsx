...
const DeptDashboard = () => {
  ...
  const [stats, setStats] = useState({
    departmentName: "Department", // Default
    totalComplaints: 0,
    pending: 0,
    resolved: 0,
    activeOfficers: 0,
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        setStats({
          departmentName: dashboardStats.departmentName || "Department", // <--- Get Name from Backend
        ...
        >
            <div>
                <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight flex items-center gap-3">
                    ...
                    {stats.departmentName} Department Command Center 
                </h1>
